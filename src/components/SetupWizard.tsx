          ...
          <ol className="space-y-4">
            {steps.map((step, i) => (
              ...
              >
                ...
                {step.command && (
                  <div className="mt-3 flex items-start gap-2 rounded-lg bg-zinc-900 p-3 dark:bg-black">
          ...
          {doneCount === steps.length && (
            <div className="mt-6 rounded-xl border border-emerald-300 bg-emerald-50 p-5 text-center dark:border-emerald-800 dark:bg-emerald-950/40">
              ...
              <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300">
                <a href="/skills/" className="text-orange-600 underline underline-offset-4 dark:text-orange-400">
                  スキル一覧
                </a>
